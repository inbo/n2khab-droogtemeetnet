...
We maakten hiervan een afgeleide databron waarin de habitatvlekken werden geïnterpreteerd: uitsluitend vlekken met een terrestrisch habitattype of een rbb werden behouden. 
...
```{r assigning-tubes-grts, cache=cache_assigning_tubes_grts}
#gecached !
...
```{r selection-polygon-cat1A, cache=cache_selection_polygon_cat1A, message=FALSE, warning= FALSE}
...
<!--chapter:end:50_sessioninfo.Rmd-->

# Literatuur {-}


<!--chapter:end:90-literatuur.Rmd-->
